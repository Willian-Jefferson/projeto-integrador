...
public class Comentarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Comentários são textos escritos dentro do programa (código-fonte) para explicar ou descrever alguns aspectos relativos ao \nmesmo.  Os comentários podem sercolocados em qualquer lugar do programa, e não fazem parte dele. São colocados entre \nos símbolos “{“ e “} “ (chaves) ou “(*” e “*)”. Exemplos: \n \n... \n\nd := b*b – 4*a*c; { cálculo do discriminante } \n\n...\n\n (* Cálculo das raízes da equação *) \nx1 := (-b + sqrt(d))/(2*a);\n x2 := (-b - sqrt(d))/(2*a);\n\n ... \n\n  A Figura 7 também mostra um programa com comentários explicando onde são as sub-áreas de declaração de constantes \ne de variáveis. ");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(323, 183, 710, 320));
