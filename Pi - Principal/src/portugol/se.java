...
public class se extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Exemplo da função se/então/senão");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 40, -1, -1));

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("algoritmo idade;\nvariáveis\n\tidade : inteiro;\n\tnome : literal;\nfim-variáveis\n\tinício\n\timprima(\"Digite seu nome:\");\n\tnome := leia();\n\timprima(nome, \", digite sua idade:\");\n\tidade := leia();\n  se idade >= 18 então\n  se idade < 60 então\n\timprima(\"adulto!\");\n  senão\n\timprima(\"ancião\", '!');\n  fim-se\n  senão\n\timprima(\"menor\", \"!\");\n  fim-se\nfim");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 80, 830, 380));
