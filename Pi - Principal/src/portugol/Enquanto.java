 ...
 * @author TI_01
 */
public class Enquanto extends javax.swing.JFrame {

    /**
     * Creates new form Enquanto
     */
    public Enquanto() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Exemplo da Função Enquanto");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 40, -1, -1));

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("algoritmo fatorial;\n\tvariáveis\n  res : inteiro;\n  fat : inteiro;\n  x : inteiro;\nfim-variáveis\n  início\n  imprima(\"Digite um número:\");\n  x := leia();\n  fat := x;\n  res := 1;\n  enquanto x <> 0 faça\n res := res * x;\n x := x - 1;\n  fim-enquanto\n imprima(\"fatorial de \",fat,\" é igual a \",res);\n fim");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 750, 380));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enquanto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
