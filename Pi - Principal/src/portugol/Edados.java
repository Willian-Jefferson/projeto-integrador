 ...
 * @author ALUNO
 */
public class Edados extends javax.swing.JFrame {

    /**
     * Creates new form Edados
     */
    public Edados() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tipos de dados primitivos");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(182, 140, 480, 110));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Edados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
