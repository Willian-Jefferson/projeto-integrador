 ...
 * @author TI_01
 */
public class Imprima extends javax.swing.JFrame {

    /**
     * Creates new form Imprima
     */
    public Imprima() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("A função imprima tem como objetivo imprimir texto no dispositivo de saída. Ela recebe um número variável\nde argumentos (pelo menos um), onde cada argumento deve ser um valor primitivo, e os imprime em\nsequencia. Ao final, é impresso um caractere de nova linha (LF) e a função retorna.\nEssa função se comporta de forma excepcional visto que não é possível declarar funções em G\u0002Portugol que recebem um número variável de argumentos.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 730, 310));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Imprima.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
