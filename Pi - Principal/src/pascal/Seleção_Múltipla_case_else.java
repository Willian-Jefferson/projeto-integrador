 ...
 * @author ALUNO
 */
public class Seleção_Múltipla_case_else extends javax.swing.JFrame {

    /**
     * Creates new form Seleção_Múltipla_case_else
     */
    public Seleção_Múltipla_case_else() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleção Múltipla: case...else... ");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 80, 790, 150));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img pascal/tb17.PNG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Seleção_Múltipla_case_else.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
